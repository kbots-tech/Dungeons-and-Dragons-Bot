...
class help(commands.Cog, name='help'):
  ...
  async def all_commands(self, ctx,*,args=""):
        ...
        embed.add_field(name='`>races [args]`',value='Use this command to get info about D&D race, if args is included it will give info about that race otherwise it will list all races.\n_Aliases:_ `>race`, `>races`, `>r`',inline=False)
        embed.add_field(name='`>class [args] [levels]`',value='Use this command to get info about D&D class, if args is included it will give info about that class otherwise it will list all class. If `levels` is appended to the end it will give info about each level.\n _Aliases:_ `>class`,`>races`, `>c`',inline=False)
        embed.add_field(name='`>spells [args]`',value='Use this command to get info about D&D spell, if args is included it will give info about that spell otherwise it will list all races.\n \n _Aliases:_ `>spell`, `>spells`, `>s`',inline=False)
        embed.add_field(name='`>equipment [args]`',value='Use this command to get info about D&D equipment, if args is included it will give info about that equipment otherwise it will list all equipment. This includes armor, weapons, and other objects.\n _Aliases:_ `>equipment`,`>e`,`>armor`,`>weapon` ',inline=False)
